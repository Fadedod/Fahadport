      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <a href="https://linkedin.com/in/fahad-qureshi-9a35a3340" target="_blank" rel="noopener noreferrer" className="text-sm text-[#BF5700] hover:underline">
              LinkedIn
            </a>
            <a href="https://github.com/Fadedod" target="_blank" rel="noopener noreferrer" className="text-sm text-[#BF5700] hover:underline">
              GitHub
            </a>
            <a href="https://media.base44.com/files/public/69ebb5a8554fbe1bce3d1f10/530af4ae7_Fahad_Resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-[#BF5700] text-[#BF5700] text-xs font-bold tracking-widest px-5 py-3 hover:bg-[#BF5700] hover:text-white transition-colors uppercase w-fit">
              Download Resume
            </a>
          </div>
        </div>
